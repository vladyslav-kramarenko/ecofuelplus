...
const resources = {
    en: {
        translation: {
            ...
            services: {
                ...
                "deliveryDescription1": "At Ecofuel+, we understand the importance of getting your biofuel safely and promptly to your location. Our production facilities are strategically located in the Volyn region, placing us in an ideal position to serve both wholesale and retail clients across Ukraine and beyond.",
            ...
            pellets: {
                "title": "Clean Heat for Your Home from EcoFuel+",
                "about": "Choose the best for your home with EcoFuel+ pellets — a modern and environmentally friendly fuel made from natural pine biomass. Our pellets are solid granules, standard length from 5 to 40 mm and diameter 6 mm, making them the perfect choice for use in pellet boilers of any power, both in residential and industrial settings.",
                "photosDescription": "We produce premium quality ENplus-A1 pellets, ensuring high heat output and minimal ash content. These pellets are available in convenient packaging — both in 15 kg bags for home use and in big bags of 1 ton for industrial needs.",
                "tableDescription": "Compare our pellets with traditional fuels such as wood, coal, and gas, and you will see their undeniable advantages: high calorific value, cost-effectiveness, and environmental friendliness. Switching to EcoFuel+ pellets is not only a contribution to the health of your home but also a significant step towards protecting the environment.",
                "parameter": "Parameter",
                "wood": "Wood",
    ...
    ua: {
        translation: {
            ...
            pellets: {
                "title": "Екологічно чисте тепло для вашого дому від EcoFuel+",
                "about": "Обирайте найкраще для свого дому з пелетами EcoFuel+ — сучасним та екологічно чистим паливом, створеним з натуральної соснової біомаси. Наші пелети представляють собою тверді гранули, стандартною довжиною від 5 до 40 мм та діаметром 6 мм, що робить їх ідеальним вибором для використання в пелетних котлах будь-якої потужності, як у побутових, так і у промислових умовах.",
                "photosDescription": "Ми виробляємо пелети преміум якості ENplus-A1, що забезпечує високу тепловіддачу та мінімальний вміст золи. Ці пелети доступні в зручній упаковці — як у мішках по 15 кг для домашнього використання, так і у великих бегах по 1 тонні для промислових потреб.",
                "tableDescription": "Порівняйте наші пелети з традиційними видами палива, такими як дерево, вугілля та газ, і ви побачите їхні беззаперечні переваги: висока калоричність, економічність та екологічність. Перехід на пелети від EcoFuel+ — це не лише вклад у здоров’я вашого дому, а й значний крок до охорони навколишнього середовища.",
                "parameter": "Параметер",
                "wood": "Дерево",
            ...
            about: {
                "Title": "ЕКОФЬЮЕЛ ПЛЮС",
                "Paragraph1": "Екофьюел+ - це українська компанія з виробництва пелет, яка націлена на надання екологічно чистих енергетичних рішень. Ми спеціалізуємося на виробництві високоякісних деревних пелет, які можна використовувати як відновлюване та чисте джерело енергії.",
                ...
                "Paragraph5": "У EcoFuel+ ми прагнемо створити більш чисте та стійке майбутнє для нашої планети. Ми запрошуємо вас приєднатися до нашої відданості екологічно чистим енергетичним рішенням і екологічному способу життя.",
            },
            footer: {
    ...
    pl: {
        translation: {
            ...
            pellets: {
                "title": "Czyste ciepło dla Twojego domu od EcoFuel+",
                "about": "Wybierz najlepsze dla swojego domu z pelletami EcoFuel+ — nowoczesnym i ekologicznym paliwem wytworzonym z naturalnej biomasy sosnowej. Nasze pellety to twarde granulki, o standardowej długości od 5 do 40 mm i średnicy 6 mm, co czyni je idealnym wyborem do stosowania w kotłach pelletowych o dowolnej mocy, zarówno w warunkach domowych, jak i przemysłowych.",
                "photosDescription": "Produkujemy pellety najwyższej jakości ENplus-A1, co zapewnia wysoką wydajność cieplną i minimalną zawartość popiołu. Te pellety są dostępne w wygodnym opakowaniu — zarówno w workach 15 kg do użytku domowego, jak i w big-bagach 1 tonę dla potrzeb przemysłowych.",
                "tableDescription": "Porównaj nasze pellety z tradycyjnymi rodzajami paliw, takimi jak drewno, węgiel i gaz, a zobaczysz ich niezaprzeczalne zalety: wysoka wartość kaloryczna, opłacalność i ekologiczność. Przejście na pellety EcoFuel+ to nie tylko wkład w zdrowie Twojego domu, ale również znaczący krok w kierunku ochrony środowiska.",
                // "about": "Pellety to nowoczesne, ekologiczne paliwo stworzone przez mechaniczne formowanie naturalnej biomasy. Pellety sosnowe to twarde granulki o długości od 5 do 40 mm i średnicy 6 mm. Stanowią główne paliwo dla kotłów na pellety i są stosowane zarówno w kotłach domowych, jak i przemysłowych o dowolnej mocy.",
    ...
    ru: {
        translation: {
            ...
            services: {
                ...
                "deliveryDescription1": "В Ecofuel+ мы понимаем важность безопасной и быстрой доставки вашего биотоплива к вам. Наши производственные мощности стратегически расположены в Волынской области, что делает нас идеальными для обслуживания как оптовых, так и розничных клиентов по всей Украине и за рубежом.",
                ...
                "deliveryDescription3": "Мы понимаем, что доставка нашего продукта к вашему порогу — это больше, чем услуга, это решение ваших потребностей в биотопливе. Выбирая Ecofuel+, вы выбираете партнера, который будет предоставлять вам лучшие продукты, которые приносят удобство и эффективность прямо вам домой или на предприятие.",
            ...
            pellets: {
                "title": "Экологически чистое тепло для вашего дома от EcoFuel+",
                "about": "Выбирайте лучшее для своего дома с пеллетами EcoFuel+ — современным и экологически чистым топливом, созданным из натуральной сосновой биомассы. Наши пеллеты представляют собой твердые гранулы, стандартной длиной от 5 до 40 мм и диаметром 6 мм, что делает их идеальным выбором для использования в пеллетных котлах любой мощности, как в бытовых, так и в промышленных условиях.",
                "photosDescription": "Мы производим пеллеты премиум качества ENplus-A1, что обеспечивает высокую теплоотдачу и минимальное содержание золы. Эти пеллеты доступны в удобной упаковке — как в мешках по 15 кг для домашнего использования, так и в биг-бегах по 1 тонне для промышленных нужд.",
                "tableDescription": "Сравните наши пеллеты с традиционными видами топлива, такими как дерево, уголь и газ, и вы увидите их неоспоримые преимущества: высокая калорийность, экономичность и экологичность. Переход на пеллеты от EcoFuel+ — это не только вклад в здоровье вашего дома, но и значительный шаг к охране окружающей среды.",
                "parameter": "Параметр",
                "wood": "Дерево",
